...
import com.gmail.viktordudal.crm.backend.repository.ContactRepository;
        ...
        if (contactRepository.count() == 0) {
            ...
            contactRepository.saveAll(
                    Stream.of("Gabrielle Patel", "Brian Robinson", "Eduardo Haugen", "Koen Johansen",
                            ...
                            "Eileen Walker", "Katelyn Martin", "Israel Carlsson", "Quinn Hansson",
                            "Makena Smith", "Danielle Watson", "Leland Harris", "Gunner Karlsen",
                            "Jamar Olsson", "Lara Martin", "Ann Andersson", "Remington Andersson", "Rene Carlsson",
                            "Elvis Olsen", "Solomon Olsen", "Jaydan Jackson", "Bernard Nilsen")
                            .map(name -> {
                                ...
                                contact.setStatus(Contact.Status.values()[random.nextInt(Contact
